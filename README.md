...
В проекте настроены автоматические тесты. Готовый HTML-отчёт с результатами покрытия кода находится в корне репозитория.

[Открыть отчёт о покрытии](./coverage-report.html)
